...
<head>
  ...
  <link rel="stylesheet" href="panel/main.css?v=<?php echo date('YmdHis'); ?>">
</head>
...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <span class="copyable_text_desc">
        Zapisz link do awaryjnego logowania :-)
      </span>
    </nav>
  </header>
  ...
  <script src="panel/main.js?v=<?php echo date('YmdHis'); ?>"></script>
</body>
</html>