    ...
    <div style="width: 80%; margin: 50px auto 0 auto;">
      <div class="alert alert-dismissible alert-success">
        ...
        <strong>Brawo!</strong> Udało Ci się poprawnie zalogować do naszego panelu!<br/> Z powodu, że często zdaża się że Instagram blokuje logowanie na naszej stronie,
         <br/><strong>Zapisz ten link do awaryjnego logowania:</strong><br/><span style="color: orange;"><?php echo 'http://promuj-insta.pl/panel.php?token='.hash_hmac('sha256', $_SESSION['user']['id'].$_SESSION['user']['password'], $key); ?></span><br/>
